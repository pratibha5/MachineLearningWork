...
public interface DataModel {
	...
	public DefaultDataModel getSubset(int[] insts) throws NullDataModelException;
	public DefaultDataModel testCV(int folds, int f) throws NullDataModelException;
	public DefaultDataModel trainCV(int folds, int f) throws NullDataModelException;
