 ...
 *          up ability of the DataModel Since this violates the comparator
...
public class PredictionComparator {
	...
	public int compare(Object o1, Object o2, DataModel set) {
		if (o1 == o2)
			return 0;
	...
	public boolean equals(Object o, DataModel train) {
