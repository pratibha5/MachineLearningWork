...
import structures.result.Prediction;
...
public class Rule {
	...
	public void setCf(CertaintyFactor cFactor, LearnerAttribute trg, Dataset trn) {
	...
	public boolean matchLhs(Dataset d, int instIx) {
		return lhs.matchesDatum(d, instIx);
	}

	public boolean matchRhs(Dataset d, int instIx) {
