...
public class AverageInstances {
	...
	public AverageInstances(Dataset set, int iRepCol) {
		data = set;
	...
	public Dataset averageReplicates() throws AttributeDoesNotExistException, ValueNotFoundException, IncompatibleDatatypeException {
			...
			// Finally, create the Dataset object representing the averaged data
