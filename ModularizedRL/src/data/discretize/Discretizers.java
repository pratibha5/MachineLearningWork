...
import data.discretize.supervised.D2S;
import data.discretize.supervised.EBD;
import data.discretize.supervised.ErrorBased;
import data.discretize.supervised.FayyadIraniEntropy;
import data.discretize.supervised.MODL;
import data.discretize.supervised.OneR;
import data.discretize.unsupervised.EqualFrequency;
import data.discretize.unsupervised.EqualWidth;
import data.discretize.unsupervised.Gaussian;
